...
class SuperAppController extends Controller
{
    ...
    public function siswakelas($angkatan, $jurusan)
    {
        ...
        return view("datasiswa.siswakelas", ["siswa" => $siswa,'data5' => $table5]);
    }
    ...
    public function profilsiswa($nis)
    {
        ...
        return view("datasiswa.profilsiswa", ["siswa" => $siswa, "catataneraport" => $catatanEraport, "riwayatkonseling" => $catatankonseling, "catatanNegatif" => $catatanNegatif, "catatanPositif" => $catatanPositif,'data5' => $table5]);
    }
    ...
    public function datajurusan($angkatan)
    {
        ...
        $table5 = ModelHasRoles::with('user')->where('role_id', '6')->orWhere('role_id', '9')->get();
        return view("datasiswa.datajurusan", ["jurusan" => $jurusan, "angkatan" => $angkatan, "jurusanall" => $jurusanall,'data5' => $table5]);
    }
    ...
    {
        $table5 = ModelHasRoles::with('user')->where('role_id', '6')->orWhere('role_id', '9')->get();
        return view("konfigurasiumum.index",['data5' => $table5]);
    }
    ...
    public function konfigurasiangkatan(Request $req)
    {
        ...
        $table5 = ModelHasRoles::with('user')->where('role_id', '6')->orWhere('role_id', '9')->get();
        return view("konfigurasiumum.konfigurasiangkatan", ["angkatan" => $angkatan,'data5' => $table5]);
    }
    ...
    public function konfigurasijurusan(Request $req)
    {
        $jurusan = Jurusan::all();
        $table5 = ModelHasRoles::with('user')->where('role_id', '6')->orWhere('role_id', '9')->get();
        return view("konfigurasiumum.konfigurasijurusan", ["jurusan" => $jurusan,'data5' => $table5]);
    }
    ...
    public function konfigurasipengguna(Request $req)
    {
        ...
        $role = Role::get();
        $table5 = ModelHasRoles::with('user')->where('role_id', '6')->orWhere('role_id', '9')->get();
        return view("konfigurasiumum.konfigurasipengguna.index", ["user" => $user, "role" => $role,'data5' => $table5]);
    }
    ...
    {
        $table5 = ModelHasRoles::with('user')->where('role_id', '6')->orWhere('role_id', '9')->get();
        return view("datasiswa.injectsiswa",['data5' => $table5]);
    }
